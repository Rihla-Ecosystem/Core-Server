...
const NON_ADMIN_USER_ID = 'bbbbbbb2-2222-4222-8222-222222222222';
const USER_TOKEN = signAccessToken({ sub: NON_ADMIN_USER_ID, role: 'user' });
...
beforeEach(async () => {
  ...
  await prisma.user.create({
    data: {
      ...
      roleId: USER_ROLE_ID,
      email: `${EMAIL_PREFIX}non_admin@example.com`,
      passwordHash: 'hash',
      displayName: 'Phase 2G-B Non Admin',
      gender: Gender.MALE,
      nationality: 'Egyptian',
    },
  });
